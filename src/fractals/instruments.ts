...
const INSTRUMENTS: Record<FractalId, FractalInstrument> = {
  ...
  5: inst({
    labels: { power: 'Bloom', bailout: 'Open', cx: 'Centre X', cy: 'Centre Y' },
    macroWeights: {
      pulsePower: 1.1,
      pulseBailout: 1.0,
      depthIters: 1.15,
    ...
    snapshots: [
      {
        name: 'Pentagon',
        macros: { pulse: 0.55, depth: 0.75, drift: 0.35, void: 0.28 },
        camera: { zoom: 0.45, rotX: 0.55, rotY: 0.9, power: 8.0, bailout: 2.8, cx: 0.15, cy: -0.1 },
        atmosphere: { fog: 0.28, fov: 1.35, gamma: 0.55, vignette: 0.65 },
        palette: 2,
      },
      {
        name: 'Golden Bloom',
        macros: { pulse: 0.7, depth: 0.85, drift: 0.55, void: 0.25 },
        camera: { zoom: 0.4, rotX: 0.45, rotY: 1.1, power: 11.0, bailout: 3.6, cx: 0.55, cy: -0.4 },
