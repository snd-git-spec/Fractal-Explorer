...
const INSTRUMENTS: Record<FractalId, FractalInstrument> = {
    ...
    snapshots: [
      {
        ...
        camera: { zoom: 2.1, rotX: 0.32, rotY: 0.6, power: 8.5, bailout: 2.8, cx: 0.15, cy: -0.12 },
  ...
  7: inst({
    ...
    snapshots: [
      {
        name: 'Lattice',
        macros: { pulse: 0.4, depth: 0.45, drift: 0.3, void: 0.35 },
        camera: { zoom: 3.8, rotX: 0.4, rotY: 0.65, power: 6.5, bailout: 2.2, cx: -0.15, cy: 0.1 },
        atmosphere: { fog: 0.32, fov: 1.35, gamma: 0.55, vignette: 0.7 },
        palette: 0,
      },
      {
        name: 'Drift',
        macros: { pulse: 0.55, depth: 0.5, drift: 0.5, void: 0.3 },
        camera: { zoom: 3.3, rotX: 0.5, rotY: 0.9, power: 7.5, bailout: 2.6, cx: 0.25, cy: -0.2 },
        atmosphere: { fog: 0.28, fov: 1.4, gamma: 0.55, vignette: 0.65 },
        palette: 1,
      },
    ],
  }),
  ...
  12: inst({
    labels: { power: 'Void Scale', bailout: 'Hall Width', cx: 'Seed X', cy: 'Seed Y' },
    macroWeights: { pulsePower: 0.7, pulseWarpX: 0.55, pulseWarpY: 0.55, depthIters: 0.55, depthZoom: 0.55 },
    snapshots: [
      {
        name: 'Grand Void',
        macros: { pulse: 0.65, depth: 0.55, drift: 0.3, void: 0.5 },
        camera: { zoom: 5.2, rotX: 0.48, rotY: 0.85, power: 8.5, bailout: 2.8, cx: 0.1, cy: -0.08 },
        atmosphere: { fog: 0.38, fov: 1.5, gamma: 0.55, vignette: 0.7 },
        palette: 0,
      },
      {
        name: 'Sparse Ribs',
        macros: { pulse: 0.8, depth: 0.5, drift: 0.4, void: 0.45 },
        camera: { zoom: 4.4, rotX: 0.55, rotY: 1.05, power: 10.5, bailout: 3.1, cx: 0.22, cy: 0.12 },
        atmosphere: { fog: 0.34, fov: 1.55, gamma: 0.55, vignette: 0.65 },
        palette: 1,
      },
    ],
  }),
  13: inst({
    ...
    snapshots: [
      { name: 'Kaleido', macros: { pulse: 0.55, depth: 0.55, drift: 0.4, void: 0.4 }, camera: { zoom: 2.4, rotX: 0.25, rotY: 0.42, power: 2.2 }, palette: 0 },
      { name: 'Spin Fold', macros: { pulse: 0.7, depth: 0.5, drift: 0.75, void: 0.3 }, camera: { zoom: 2.1, rotX: 0.35, rotY: 0.65, power: 2.2 }, palette: 1 },
      { name: 'Crystal Spire', macros: { pulse: 0.4, depth: 0.65, drift: 0.35, void: 0.5 }, camera: { zoom: 2.8, rotX: 0.18, rotY: 0.32, power: 2.2 }, palette: 3 },
    ],
  }),
  14: inst({
    ...
    snapshots: [
      {
        ...
        camera: { zoom: 0.05, rotX: 0.42, rotY: 0.75 },
      ...
      },
      {
        ...
        camera: { zoom: 0.05, rotX: 0.5, rotY: 0.95 },
    ...
    snapshots: [
      {
        ...
        camera: { zoom: 1.7, rotX: 0.5, rotY: 0.85 },
      ...
      },
      {
        ...
        camera: { zoom: 1.7, rotX: 0.6, rotY: 1.1 },
  ...
  18: inst({
    ...
    snapshots: [
      {
        name: 'Layered Sponge',
        macros: { pulse: 0.5, depth: 0.7, drift: 0.4, void: 0.3 },
        camera: {
          zoom: 2.3,
          rotX: -0.92,
          rotY: 2.35,
      ...
      {
        name: 'Surf Cut',
        macros: { pulse: 0.7, depth: 0.75, drift: 0.6, void: 0.25 },
        camera: {
          zoom: 2.4,
          rotX: -1.15,
          rotY: 0.35,
        ...
        atmosphere: { fog: 0.25, fov: 1.45, gamma: 0.55, vignette: 0.6 },
        palette: 0,
      },
    ],
  }),
