...
const INSTRUMENTS: Record<FractalId, FractalInstrument> = {
  ...
  12: inst({
    ...
    macroWeights: { pulsePower: 0.55, pulseWarpX: 0.5, pulseWarpY: 0.5, depthIters: 0.45 },
    snapshots: [
      {
        name: 'Limit Group',
        macros: { pulse: 0.4, depth: 0.55, drift: 0.3, void: 0.45 },
        camera: { zoom: 1.8, rotX: 0.38, rotY: 0.65, power: 6.0, bailout: 2.2, cx: 0.12, cy: 0.28 },
        atmosphere: { fog: 0.3, fov: 1.35, gamma: 0.55, vignette: 0.7 },
        palette: 0,
      },
      {
        name: 'Möbius Web',
        macros: { pulse: 0.55, depth: 0.5, drift: 0.45, void: 0.35 },
        camera: { zoom: 1.6, rotX: 0.45, rotY: 0.85, power: 7.2, bailout: 2.5, cx: 0.3, cy: -0.15 },
        atmosphere: { fog: 0.28, fov: 1.4, gamma: 0.55, vignette: 0.65 },
        palette: 1,
      },
    ],
