...
export const FRACTALS: FractalMeta[] = [
  ...
  { id: 5, slug: 'dodecahedron', name: 'Dodecahedron IFS', label: '5-fold Pentagonal', equation: 'Golden-plane folds × φ² scale from stretch centre  ·  Classic Dodecahedron IFS (Syntopia / Knighty)' },
