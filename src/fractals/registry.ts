...
export const FRACTALS: FractalMeta[] = [
  ...
  { id: 3, slug: 'menger', name: 'Menger Sponge', label: 'Infinite IFS Cross Fold', equation: 'S = ⋃ scᵏ·A — IFS cross-subtraction self-similar inward & outward  ·  Menger Sponge' },
  { id: 4, slug: 'apollonian', name: 'Apollonian', label: 'Inversive Spheres', equation: 'Inversive Spheres: p→p·k/|p|²  ·  Apollonian Gasket' },
  { id: 5, slug: 'dodecahedron', name: 'Dodecahedron IFS', label: '5-fold Recursive Lace', equation: 'IFS → 20 dodeca vertices · S=⋃ scᵏA  ·  Same solid at every scale — zoom in or out forever' },
  ...
  { id: 18, slug: 'asurf-menger', name: 'Tidefold', label: 'Surf Lattice Hybrid', equation: 'S = ⋃ scᵏ·A — Surf caverns → Menger sponge, self-similar forever  ·  Tidefold' },
];
